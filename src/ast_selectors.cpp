...
namespace Sass {
  ...
  : Selector(pstate),
    Vectorized<ComplexSelectorObj, SelectorList>(s),
    is_optional_(false)
  { }
  SelectorList::SelectorList(const SelectorList* ptr)
    : Selector(ptr),
    Vectorized<ComplexSelectorObj, SelectorList>(*ptr),
  ...
  : Selector(pstate),
    Vectorized<SelectorComponentObj, ComplexSelector>(),
    chroots_(false),
  ...
  : Selector(ptr),
    Vectorized<SelectorComponentObj, ComplexSelector>(ptr->elements()),
  ...
  CompoundSelector::CompoundSelector(ParserState pstate, bool postLineBreak)
    : SelectorComponent(pstate, postLineBreak),
      Vectorized<SimpleSelectorObj, CompoundSelector>(),
  ...
  CompoundSelector::CompoundSelector(const CompoundSelector* ptr)
    : SelectorComponent(ptr),
      Vectorized<SimpleSelectorObj, CompoundSelector>(*ptr),
