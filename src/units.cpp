...
namespace Sass
{
  ...
  const double size_conversion_factors[6][6] = {
    ...
    /* px   */
    {
    1.0 / 96.0, 2.54 / 96.0, 6.0 / 96.0, 25.4 / 96.0, 72.0 / 96.0, 1,
    }
  };
  ...
  UnitClass get_unit_type(UnitType unit)
  {
    ...
    case UnitClass::LENGTH:
      return UnitClass::LENGTH;
    case UnitClass::ANGLE:
      return UnitClass::ANGLE;
    case UnitClass::TIME:
      return UnitClass::TIME;
    case UnitClass::FREQUENCY:
      return UnitClass::FREQUENCY;
    case UnitClass::RESOLUTION:
      return UnitClass::RESOLUTION;
    default:
      return UnitClass::INCOMMENSURABLE;
    }
  };
  ...
  double conversion_factor(const std::string& s1, const std::string& s2, bool strict)
  {
    ...
    if (u1 != UNKNOWN && u2 != UNKNOWN)
    {
      ...
      case UnitClass::INCOMMENSURABLE:
        return 0;
      default:
        break;
      }
