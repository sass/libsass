...
namespace Sass {
    ...
    std::vector<SelectorComponentObj> queue2)
  {
    ...
    for (auto group : LCS) {
      ...
      std::vector<std::vector<SelectorComponentObj>>
        expanded = forEach(chunks, flatten<std::vector,
          std::vector<std::vector<SelectorComponentObj>>>);
    ...
    choices.emplace_back(std::move(forEach(chunks, flatten<std::vector,
      std::vector<std::vector<SelectorComponentObj>>>)));
    ...
    std::vector<std::vector<SelectorComponentObj>>
      results = forEach(permutate(choices), flatten<std::vector,
        std::vector<std::vector<SelectorComponentObj>>>);
