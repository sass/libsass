...
namespace Sass {
  ...
  class Eval : public Operation_CRTP<Expression*, Eval> {
   ...
   public:
    ...
    // Expression* operator()(Custom_Warning*);
    ...
    static Value* op_numbers(Memory_Manager<AST_Node>&, enum Sass_OP, Number*, Number*, bool compressed = false, int precision = 5);
    static Value* op_number_color(Memory_Manager<AST_Node>&, enum Sass_OP, Number*, Color*, bool compressed = false, int precision = 5);
    static Value* op_color_number(Memory_Manager<AST_Node>& mem, enum Sass_OP, Color*, Number*, bool compressed = false, int precision = 5);
    static Value* op_colors(Memory_Manager<AST_Node>& mem, enum Sass_OP, Color*, Color*, bool compressed = false, int precision = 5);
    static Value* op_strings(Memory_Manager<AST_Node>& mem, enum Sass_OP, Value*, Value*, bool compressed = false, int precision = 5);
